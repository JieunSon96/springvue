<template>
  <!-- Footer -->
  <mdb-footer color="unique-color-dark" class="fixed-bottom page-footer font-small pt-0">
    ...
    <mdb-container class="mt-5 mb-4 text-center text-md-left">
      <mdb-row class="mt-3">
        ...
        <mdb-col md="4" lg="3" xl="3" class="mb-4">
          ...
          <p><i class="fas fa-envelope mr-3"></i> plmn855000@gmail.com</p>
          <p><i class="fas fa-phone mr-3"></i> + 82 010 6402 6090</p>
